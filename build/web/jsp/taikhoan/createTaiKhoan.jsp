...
<body>  
    ...
    <p>NOTE: Nhập đầy đủ thông tin tài khoản.</p>  

    <form action="taikhoans?action=create" method="post">      
        <label class="pad_top">Tên Tài Khoản:</label>  
        <input type="text" name="tenTaiKhoan" required><br>  
