    ...
    <body>
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <h2>
                    <a href="thanhphos?action=create">Thêm Mới Thành Phố</a>
                </h2>
                <form action="thanhphos?action=search" method="get" class="search-form">
                ...
                <c:set var="totalCities" value="${cities.size()}"/>
                <c:set var="totalPages" value="${Math.ceil(totalCities / pageSize)}"/>
                ...
                <div>
                    <c:if test="${currentPage > 1}">
                        <a href="thanhphos?page=${currentPage - 1}">Trước</a>
                    </c:if>

                    <c:forEach var="i" begin="1" end="${totalPages}">
                        <a href="thanhphos?page=${i}">${i}</a>
                    </c:forEach>

                    <c:if test="${currentPage < totalPages}">
                        <a href="thanhphos?page=${currentPage + 1}">Sau</a>
                    </c:if>
                </div>
            </main>
        </div>  
