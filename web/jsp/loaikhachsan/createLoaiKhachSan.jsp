...
<head>  
    ...
    <title>Create Loại Khách Sạn</title>  
    <style>
...
<body>  
    ...
    <h1>Thêm Loại Khách Sạn</h1>  
    <p>NOTE: Nhập đầy đủ thông tin loại khách sạn.</p>  

    <form action="loaikhachsans?action=create" method="post">      
