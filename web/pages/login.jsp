            ...
            <div class="login">
                ...
                <div class="row2">
                    ...
                    <div class="login-social">
                        <button type="submit" class="row facebook">
                            <img src="../Content/Images/facebook.png" alt="alt"/>
                            <div>Facebook</div>
                        </button>
                        <button type="submit" class="row google">
                            <img src="..//Content/Images/google.png" alt="alt"/>
                            <div>Google</div>
                        </button>
                    </div>              
                </div>   
